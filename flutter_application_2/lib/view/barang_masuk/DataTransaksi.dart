...
import 'package:flutter_application_2/view/barang_masuk/DetailTransaksi.dart';
import 'package:flutter_application_2/view/barang_masuk/KeranjangBm.dart';
...
class _DataTransaksiState extends State<DataTransaksi> {
  ...
  Future<void> _lihatData() async {
    ...
    if (response.contentLength == 2) {
      ...
      data.forEach((api) {
        final ab = new TransaksiMasukModel(
            api['id_transaksi'],
            api['nama_barang'],
            api['tujuan'],
            api['total_item'],
